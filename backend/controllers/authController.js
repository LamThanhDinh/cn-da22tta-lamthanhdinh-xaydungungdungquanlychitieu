...
const forgotPassword = async (req, res) => {
  try {
    ...
    try {
      ...
      // Nếu gửi email thất bại, vẫn log mã ra console để test
      console.log("⚠️ Email sending failed. Reset token for", email, ":", resetToken);
      
      res.json({
        message: "Mã xác thực đã được tạo nhưng không thể gửi email. Vui lòng liên hệ admin.",
        // CHỈ để fallback khi email service lỗi - có thể xóa trong production
